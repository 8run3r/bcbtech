...
const CORPUS: { keywords: string; title: string; route: string; snippet: string }[] = [
  ...
  { keywords: "agent agenti ai chatbot asistent claude podpora support", title: "AI Agenti", route: "/balicky?tab=agents", snippet: "Assistant 690 € · Agent Pro 1 290 € · Fleet 2 900 €" },
  { keywords: "faktúra fakturácia doklady účtovníctvo platby upomienky párovanie", title: "Fakturácia & Doklady", route: "/balicky?tab=automation", snippet: "Fakturačný modul od 290 € · automatizácie od 390 €" },
...
const PRICING_TABLE = [
  ...
  "  AUTOMATION & FAKTURÁCIA",
  "    Workflow setup    od   390 €",
  "    Fakturačný modul  od   290 €",
  "  HYBRID",
